...
<div class="max-w-80 h-[332px] p-6 mx-auto bg-white bg-opacity-50 shadow-lg rounded-2xl overflow-hidden border">
    ...
    <div class="">
        <p class="text-[#333333] font-normal text-xs hp:text-sm max-w-[273px] my-5">{{ $message }}</p>
