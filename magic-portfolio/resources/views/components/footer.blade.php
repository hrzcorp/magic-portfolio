    ...
    <div class="container mx-auto">
        <div class="md:flex md:gap-[172px] md:pb-10 pb-2">
            <div class="w-full md:w-[295px]">
                <x-logo/>
                <p class="pt-8 font-normal text-sm">Lorem ipsum dolor sit amet consectetur. Nulla vitae purus turpis est nibh rhoncus turpis. Nulla diam ut bibendum sollicitudin.</p>
            </div>
        ...
        <div class="md:flex md:justify-between items-center border-t pt-4 text-sm font-satoshi">
            <div class="flex gap-[50px] justify-between">
                <div class="flex gap-2 items-center">
                    ...
                    <span class="font-medium text-sm">+1 562 832 538</span>
                </div>
                <div class="flex gap-2 items-center">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="font-medium text-sm">info@simplehire.com</span>
                </div>
            </div>
            <p class="font-normal text-sm text-center">All Rights Reserved ®Simplehire 2023</p>
        </div>
    </div>
</footer>